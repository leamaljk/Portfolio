<template>
  <div class="app">
      ...
      <section id="portfolio">
        <div class="project">
          <img class="project__image" src="../../assets/images/projects/ohmyfood (1).png"  />
          <div class="glass"></div>
        ...
        <div class="project">
          <img class="project__image" src="../../assets/images/projects/ohmyfood (2).png"  />
          <div class="glass"></div>
          <div class="glass-overlay"></div>
          <p>ohmyfood</p>
          <h3 class="grid__title"> click to see the gallery</h3>
        ...
        <div class="project">
          <img class="project__image" src="../../assets/images/projects/ohmyfood (3).png"  />
          <div class="glass"></div>
          <div class="glass-overlay"></div>
          <p>ohmyfood</p>
          <h3 class="grid__title"> click to see the gallery</h3>
        ...
        <div class="project">
          <img class="project__image" src="../../assets/images/projects/ohmyfood (4).png"  />
          <div class="glass"></div>
          <div class="glass-overlay"></div>
          <p>ohmyfood</p>
          <h3 class="grid__title"> click to see the gallery</h3>
        ...
        <div class="project">
          <img class="project__image" src="../../assets/images/projects/ohmyfood (5).png"  />
          <div class="glass"></div>
          <div class="glass-overlay"></div>
          <p>ohmyfood</p>
          <h3 class="grid__title"> click to see the gallery</h3>
        ...
        <div class="project">
          <img class="project__image" src="../../assets/images/projects/ohmyfood (6).png"  />
          <div class="glass"></div>
          <div class="glass-overlay"></div>
          <p>ohmyfood</p>
          <h3 class="grid__title"> click to see the gallery</h3>
    ...
    <div class="content">
      <h2>ohmyfood</h2>
      <h3>Integrate a mobile website with animations in CSS </h3>
     
    
      <section class="id-live">
        <div class="box">
          <h3 class="box-title">I used</h3>
        <p class="box-p">
          SASS
          <br> 
          Keyframes
        ...
        <p class="box-p">
          When arriving on the home page a loading animation will cover the whole screen for 3 seconds.    <br><br>
        </p>
        </div>
        
        <div class="box">
        <h3 class="box-title">Menu Pages</h3>
        <p class="box-p">
          After selecting certain page, the dishes appear gradually with a slight time lag.    
          <br><br>
          A small checkmark will appear to the right of the dish. This tick slide from right to left.If the title of the dish is too long, it will be trimmed with suspension points (the effect displays on hover).    <br>
        </p>
        </div>
        ...
        <p class="box-p">
          When hovering, the background color of the main buttons be lighten slightly. The drop shadow also be more visible.      <br><br>
        <br><br>
        ...
        <div class="box">
          <h3 class="box-title">Side informations </h3>
        <p class="box-p">
      ...
      <a href="https://leamaljk.com/ohmyfood/" target="_blank" class="live-link-button">Visit live website</a>
    </div>
    </section>
