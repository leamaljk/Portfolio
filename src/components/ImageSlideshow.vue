...
export default {
  ...
  data() {
    return {
      ...
      slides: [
        { image: require('../assets/images/slides/1.webp') },
        { image: require('../assets/images/slides/2.webp') },
        { image: require('../assets/images/slides/3.webp') },
        { image: require('../assets/images/slides/4.webp') },
        { image: require('../assets/images/slides/5.webp') },
        { image: require('../assets/images/slides/6.webp') },
        { image: require('../assets/images/slides/7.webp') },
        { image: require('../assets/images/slides/8.webp') },
